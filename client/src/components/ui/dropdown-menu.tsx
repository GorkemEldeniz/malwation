...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "data-[state=open]:bg-primary-hover flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none dark:focus:bg-primary dark:data-[state=open]:bg-primary",
      inset && "pl-8",
      className
    )}
    {...props}
